...
for transferFcnName=["compet", "elliotsig", "hardlim", "hardlims", "logsig", "netinv", "poslin", "purelin", "radbas", "radbasn", "satlin", "satlins", "softmax", "tansig", "tribas"]
    rmse=ones([10,1]);
    for j=1:10
        %test set
        rows = limit-1;
    ...
    %     net.trainParam.showWindow = 0;
        ...
        net.layers{1}.transferFcn = transferFcnName;
        count=0;
        y=ones(44,3);
...
disp(transferFcnName + ': ' + mean(rmse(:,1)));
end
toc;
